...
class Member(models.Model):
    ...
    census_number = models.IntegerField()
    house_name = models.TextField()
    jp_number = models.DecimalField(decimal_places=3, max_digits=1000)
    name = models.TextField()
    is_active = models.BooleanField()
    is_head = models.BooleanField()
    is_due_apply = models.BooleanField()
    is_pension = models.BooleanField()
    ...
    postoffice = models.TextField(null=True)
...
class Due(models.Model):
    ...
    is_pension = models.IntegerField()
    is_nri = models.IntegerField()
...
class AccountTransactionRecord(models.Model):
...
class MemberFamilyChange(models.Model):
