...
function NewFamilyForm() {
    ...
    function handleSubmit(e: React.FormEvent): void {
        ...
        const config = {
            method: 'post',
            url: process.env.NEXT_PUBLIC_BACKEND_URL+'/api/new-family/',
            headers: {
    ...
    return (
        <Layout>
            <PageTitle>New Family</PageTitle>
            ...
            <div className="px-4 py-3 mb-8">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <br/><br/>
                    <SectionTitle>Member Details (Head Of The Family)</SectionTitle>
                    
                    <Label className="mt-4">
                        <span>Member No. (JP)</span>
                        <Input className="mt-1" name="jp_number" value={formData.jp_number} onChange={handleInputChange} />
                    </Label>
