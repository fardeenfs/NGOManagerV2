...
const IncomeVouchersReport = () => {
    ...
    const handleSubmit = (e: React.FormEvent, reportType: string) => {
        ...
        const config = {
            method: 'post',
            url: process.env.NEXT_PUBLIC_BACKEND_URL+'/api/reports/income-vouchers/',
            headers: {
        ...
        .then(response => {
            ...
            link.href = url;
            link.setAttribute("download", `IncomeVouchersReport.xlsx`);
...
export default IncomeVouchersReport;