...
const DuesCancelledReport = () => {
    ...
    const handleSubmit = (e: React.FormEvent, reportType: string) => {
        ...
        const config = {
            method: 'post',
            url: process.env.NEXT_PUBLIC_BACKEND_URL+'/api/reports/dues-cancelled/',
            headers: {
        ...
        .then(response => {
            ...
            link.href = url;
            link.setAttribute("download", `DuesCancelledReport.xlsx`);
...
export default DuesCancelledReport;